function [data_correct, artifact_topographies, data_clean, P,filt_ker,SSP_SIR_operator,artifact_spectrum] = SSP_SIR_TM(data, PC, LFM, M, badC, is_ave_ref,fs,timeAxis,TimeROI)
