...
%   $Revision: 1.20.4.13 $ $Date: 2013/08/23 23:45:33 $ 
...
switch option
    case 'create'
        ...
        uimenu(m_load,...
            ...
            'Position',1,          ...
            'Callback',['wp2dmngr(''load_img'',' str_numwin ');'] ...
            );
        uimenu(m_load,...
            'Label',getWavMSG('Wavelet:commongui:Str_Decomp'), ...
            'Position',2,                  ...
            'Callback',['wp2dmngr(''load_dec'',' str_numwin ');'] ...
            );

        uimenu(m_save,...
            'Label',getWavMSG('Wavelet:commongui:Syn_Img'),...
            'Position',1,         ...
            'Callback',['wp2dmngr(''save_synt'',' str_numwin ');'] ...
            );
        uimenu(m_save,...
            'Label',getWavMSG('Wavelet:commongui:Str_Decomp'), ...
            'Position',2,              ...
            'Callback',['wp2dmngr(''save_dec'','  str_numwin ');']  ...
            );
        ...
        uimenu(m_imp_wrks,...
            ...
            'Tag','Import_Img', ...
            'Callback',['wp2dmngr(''import_img'',' str_numwin ');'] ...
            );
        uimenu(m_imp_wrks,...
            'Label',getWavMSG('Wavelet:commongui:Str_ImportDec'), ...
            'Tag','Import_Dec', ...
            'Callback',['wp2dmngr(''import_dec'',' str_numwin ');'] ...
            );
        
        cb_beg = ['wp2dmngr(''exp_wrks'',' str_numwin];        
        uimenu(m_exp_wrks,...
