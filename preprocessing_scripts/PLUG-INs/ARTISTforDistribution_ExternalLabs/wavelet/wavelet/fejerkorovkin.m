...
%   associated with Fejer-Korovkin wavelet specified by the string W where 
%   W = 'fkN'.
...
% Check input arguments only one input argument
narginchk(1,1)

% Transfer string to lower case for matching
wname = lower(w);

% Supported wavelets
SupportedWavelets = {'fk4','fk6','fk8','fk14','fk22'};
