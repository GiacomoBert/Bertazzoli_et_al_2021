...
switch wname
    ...
    case 'dogpow' ,              wft = {'alpha',1.25,1.25;'p',2,2};
    case {'endstop1','esmorl','morl','rmorl'}
                                    wft = {'omega0',6,'sigma',1,'epsilon',1};
    case {'endstop2','isomorl'} ,   wft = {'omega0',6,'sigma',1};
    case 'esmexh' ,                 wft = {'sigma',1,'epsilon',0.5};
    case {'gaus3'} ,                wft = {'order',1,'sigma',1};
    case {'isodog','sdog','dog2'}  ,wft = {'alpha', 1.25};
    case 'pethat' ,                 wft = {};
...
nbIN = length(varargin);
if nbIN<1 , alpha = 1.25; else alpha = varargin{1}; end
if nbIN<2 , pow   = 1;    else pow = varargin{1}; end
