...
%DGUICF2D Shows 2-D wavelet coefficients selection GUI tools in the Wavelet Toolbox.
%
...
if nargin>0
	...
	switch action
	  ...
	  case 'getFigParam'
		  figName  = getWavMSG('Wavelet:wavedemoMSGRF:DGUI_CF2D');
		  showType = 'command';
	  ...
	  case 'slidePROC'
          ...
          demoSET = {...
              ...
              'facets'  , 'bior6.8', 5, {'Global'}   , 'COL' ; ...
              'facets'  , 'bior6.8', 5, {'Stepwise',[576,200,4076]}  , 'COL' ; ...
