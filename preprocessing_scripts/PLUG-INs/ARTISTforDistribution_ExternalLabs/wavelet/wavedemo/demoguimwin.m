...
% DEMOGUIMWIN MATLAB file for demoguimwin.fig
...
% Last Modified by GUIDE v2.5 19-Apr-2006 17:58:11
%
%   M. Misiti, Y. Misiti, G. Oppenheim, J.M. Poggi 12-Mar-96.
%   Last Revision: 23-May-2012.
%   Copyright 1995-2012 The MathWorks, Inc.
%   $Revision: 1.1.6.4.14.4 $ $Date: 2011/02/08 17:03:36 $
...
%*************************************************************************%
function varargout = demoguimwin_OutputFcn(~,~,handles)
...
%                -------------------------                                %
%=========================================================================%
function Init_Tool(hObject,~,~,varargin)
...
% Set colors and fonts for the figure.
%---------------------------------------
wfigmngr('set_FigATTRB',hObject,'wavedemo');
