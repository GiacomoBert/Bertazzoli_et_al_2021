function out1 = demoscen(option,in2,in3) %#ok<INUSD>
%DEMOSCEN Shows typical wavelet 1-D scenarios using the Wavelet Toolbox. 
%   DEMOSCEN shows Short 1-D scenario example.

%   DEMOSCEN('auto') shows Short 1-D scenario example
%   in automatic mode.
%
%   DEMOSCEN('gr_auto') shows Short 1-D scenario example
%   in automatic mode: first in the increasing slide
%   order and then in the decreasing slide order.
%
%   DEMOSCEN('loop') shows Short 1-D scenario example
%   in loop mode.
...
switch option
    ...
    case {'dw1d'}
        %*****************************************************%
        %** OPTION = 'dw1d' -  example DW1D  (now only)     **%
        %*****************************************************%
        expo_flag = 0;
