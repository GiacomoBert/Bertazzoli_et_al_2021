...
%DCMDDW2D Shows discrete 2-D wavelet tools in the Wavelet Toolbox. 
%
...
if nargin>0
	...
	switch action
	  ...
	  case 'getFigParam'
		figName  = getWavMSG('Wavelet:wavedemoMSGRF:Orthogonal_2D');
		showType = 'mix9';
	  ...
	  case 'initShowViewer'
		...
		pos(2) = pos(2)-2*hBtn;
        popstr = {...
            'woman2','sinsin','detfingr','wbarb','detail','geometry', ...
            'tire','mandrill','woman','wifs','facets','tartan'};
        txtstr = getWavMSG('Wavelet:commongui:Str_Image');
        ...
        propUIC = {'Units',propAuto{1},'Position',pos,'BackgroundColor','w'};
		propAuto{2} = pos;
...
if nargout<1,
  ...
  slide(idx).text = {
	''
    getWavMSG('Wavelet:wavedemoMSGRF:Press_StartBtn','2-D wavelet')
	''
  ...
  slide(idx).text = {
	...
	'         load  imgName'
	getWavMSG('Wavelet:wavedemoMSGRF:Comment_LoadImg')
	'         nbcol = size(map,1);'
	'         cod_X = wcodemat(X,nbcol);'
	''};
  ...
  slide(idx).code = {
	  ...
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:DecAtLev_L'',1));'
	  '' };

  slide(idx).text = {
	  getWavMSG('Wavelet:wavedemoMSGRF:Dec_Step1')
	  '        [ca1,ch1,cv1,cd1] = dwt2(X,''db1'');'
	  ' '
	  getWavMSG('Wavelet:wavedemoMSGRF:Image_coding')
	  '        cod_ca1 = wcodemat(ca1,nbcol);'
	  '        cod_ch1 = wcodemat(ch1,nbcol);'
	  '        cod_cv1 = wcodemat(cv1,nbcol);'
	  '        cod_cd1 = wcodemat(cd1,nbcol);'
  ...
  slide(idx).code = {
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:CfsApp_L'',1));'
	  ''};
  ...
  slide(idx).code = {
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:CfsHDet_L'',1));'
	  '' };
  ...
  slide(idx).code = {
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:CfsVDet_L'',1));'
	  '' };
  ...
  slide(idx).code = {
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:CfsDDet_L'',1));'
	  '' };
  ...
  slide(idx).code = {
	 ['idxPREV = wshowdrv(''#get_idxSlide'',figHandle); idxSlide = ' int2str(idx) ';']
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:DecAtLev_L'',2));'
	  '' };

  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:PerformStep2Dec',1)
	  '        [ca2,ch2,cv2,cd2] = dwt2(ca1,''db1'');'
	  ' ' 
	  getWavMSG('Wavelet:wavedemoMSGRF:Code_CFS_a2h2v2d2')
  ...
  slide(idx).text = {
	  getWavMSG('Wavelet:wavedemoMSGRF:ZoomDecLev2')
	  '' };
  ...
  slide(idx).code = {
	  ...
	  'axis(''square'');'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:RecImg_a0''));'
	  '' };

  slide(idx).text = {
	  getWavMSG('Wavelet:wavedemoMSGRF:InvDec_Lev1')
  ...
  slide(idx).text = {
	  getWavMSG('Wavelet:wavedemoMSGRF:PerformDecLev2')
	  '         [c,s] = wavedec2(X,2,''db1'');'
	  '' };
  ...
  slide(idx).code = {
	 ['idxPREV = wshowdrv(''#get_idxSlide'',figHandle); idxSlide = ' int2str(idx) ';']
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:CfsAtLev_L'',2));'
	  '' };

  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:ExtCfsAtLev_fromCS',2)
	  '         ca2 = appcoef2(c,s,''db1'',2);'
	  '         ch2 = detcoef2(''h'',c,s,2);'
	  '         cv2 = detcoef2(''v'',c,s,2);'
	  '         cd2 = detcoef2(''d'',c,s,2);'
  ...
  slide(idx).code = {
	 ['idxPREV = wshowdrv(''#get_idxSlide'',figHandle); idxSlide = ' int2str(idx) ';']
	  ...
	  'line(''XData'',[1 col],''YData'',[row/2 row/2],''Color'',lineCOL);'
	  'line(''XData'',[col/2 col/2],''YData'',[1 row],''Color'',lineCOL);'
	  'title(getWavMSG(''Wavelet:wavedemoMSGRF:CfsAtLev_L'',1));'
	  '' };

  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:ExtCfsAtLev_fromCS',1)
	  '        ca1 = appcoef2(c,s,''db1'',1);'
	  '        ch1 = detcoef2(''h'',c,s,1);'
	  '        cv1 = detcoef2(''v'',c,s,1);'
	  '        cd1 = detcoef2(''d'',c,s,1);'
  ...
  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:Plot_OriImg')
	  '' };
  ...
  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:RecAppLev_L_fromCS',2)
	  '        a2 = wrcoef2(''a'',c,s,''db1'',2);'
	  '' };
  ...
  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:RecDetLev_L_fromCS',2)
	  '         h2 = wrcoef2(''h'',c,s,''db1'',2);'
	  '         v2 = wrcoef2(''v'',c,s,''db1'',2);'
	  '         d2 = wrcoef2(''d'',c,s,''db1'',2);'
	  '' };
  ...
  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:OneStepRec')
	  '        [c,s] = upwlev2(c,s,''db1'');'
	  '' };
  ...
  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:RecAppDet_OneStepRec')
      '' };
  ...
  slide(idx).text = {
      getWavMSG('Wavelet:wavedemoMSGRF:RecImg_X_fromCS')
	  '         a0 = waverec2(c,s,''db1'');'
	  '' };
