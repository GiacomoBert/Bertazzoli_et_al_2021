...
%DGUICWIM Shows complex continuous 1-D wavelet GUI tools in the Wavelet Toolbox. 
%
...
if nargin>0
	...
	switch action
	  ...
	  case 'getFigParam'
		figName  = getWavMSG('Wavelet:wavedemoMSGRF:DGUI_CWIM');
		showType = 'command';
		...
		switch idxSlide
		  case 3
			  if idxPREV<idxSlide
				  ...
				  str_col = str_col{map_val};
                  msg = getWavMSG('Wavelet:wavedemoMSGRF:dguicw1d_MSG_1',str_col);
		  ...
		  case 4
              ...
              msg = getWavMSG('Wavelet:wavedemoMSGRF:dguicw1d_MSG_2', ...
                        str_ccm_old,str_ccm_new);
			  wshowdrv('#gui_wait',figHandle,active_fig,msg); 
		  ...
		  case 6
			  msg = getWavMSG('Wavelet:wavedemoMSGRF:dguicw1d_MSG_3');
			  wshowdrv('#gui_wait',figHandle,active_fig,msg); 
			  set(pop_pal,'Value',4);
			  eval(cba_pal);
