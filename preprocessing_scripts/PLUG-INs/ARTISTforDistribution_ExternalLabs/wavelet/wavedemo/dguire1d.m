...
%DGUIRE1D Shows 1-D Regression estimation GUI tools in the Wavelet Toolbox.
%
...
if nargin>0
	...
	switch action
	  ...
	  case 'getFigParam'
		  figName  = getWavMSG('Wavelet:wavedemoMSGRF:DGUI_RE1D');
		  showType = 'command';
