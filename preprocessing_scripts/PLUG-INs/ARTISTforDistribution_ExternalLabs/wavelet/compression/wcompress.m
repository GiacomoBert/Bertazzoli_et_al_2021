...
% Compression:
% ===========
%   WCOMPRESS('c',X,SAV_FILENAME,COMP_METHOD) compresses the image X 
%   using the compression method COMP_METHOD. 
%   The compressed image is saved in the file SAV_FILENAME. 
%   X can be either a 2-D array containing an indexed image or  
%   a 3-D array of uint8 containing a truecolor image.
%
...
%   mode. Each of the two dimensions of the image must be powers of 2.
%   -------------------------------------------------------------------
%
...
%   subplot(1,2,2); image(Xc); title('Compressed image'); axis square
%
%   See also IMREAD, IMWRITE, WMAXLEV.
    ...
    case 'c'	% COMPRESS
        ...
        switch method_COMP
            case {'gbl_mmc_h','gbl_mmc_f'}
                ...
                Encoded_wtbx_DEC = wtcmngr('enc',method_COMP,...
        ...
        fileSize = wtcmngr('save',Sav_filename,method_COMP,Encoded_wtbx_DEC);
