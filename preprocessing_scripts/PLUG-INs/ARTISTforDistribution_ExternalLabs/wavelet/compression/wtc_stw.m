function varargout = wtc_stw(option,varargin)
...
switch numOPT
    ...
    case 1 , [varargout{1:nbout}] = wtc_stw_enc(varargin{:});
        %-- 'decode' --%
    case 2 , [varargout{1:nbout}] = wtc_stw_dec(varargin{:});
        %--- 'save' ---%
    case 3 , [varargout{1:nbout}] = wtc_stw_save(varargin{:});
        %--- 'load' ---%
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function Xrec = wtc_stw_dec(WTC_Struct,stepFLAG)
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function fileSize = wtc_stw_save(filename,WTC_Struct)
