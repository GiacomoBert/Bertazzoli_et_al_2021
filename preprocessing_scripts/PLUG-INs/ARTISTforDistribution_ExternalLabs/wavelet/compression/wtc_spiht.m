function varargout = wtc_spiht(option,varargin)
...
switch numOPT
    ...
    case 2 , [varargout{1:nbout}] = wtc_spiht_dec(varargin{:});
        %--- 'save' ---%
    case 3 , [varargout{1:nbout}] = wtc_spiht_save(varargin{:});
        %--- 'load' ---%
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
function fileSize = wtc_spiht_save(filename,WTC_Struct)
...
% Begin Saving.
%--------------
codeID = wtcmngr('meth_ident','spiht');
