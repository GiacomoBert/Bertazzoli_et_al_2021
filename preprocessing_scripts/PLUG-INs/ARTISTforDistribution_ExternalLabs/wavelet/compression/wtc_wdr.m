function varargout = wtc_wdr(option,varargin)
...
switch numOPT
    ...
    case 2 , [varargout{1:nbout}] = wtc_wdr_dec(varargin{:});
        %--- 'save' ---%
    case 3 , [varargout{1:nbout}] = wtc_wdr_save(varargin{:});
        %--- 'load' ---%
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function fileSize = wtc_wdr_save(filename,WTC_Struct)   
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function fileSize = wtc_wdr_save_NEW(filename,WTC_Struct)   %#ok<DEFNU>
