...
old_FAM = wtcmngr('meth_fam',old_METHOD);
new_FAM = wtcmngr('meth_fam',MethodCOMP);
...
switch MethodCOMP    
    case {'gbl_mmc_h','gbl_mmc_f'}
        ...
        % Writing and Reading.
        %---------------------
        wtcmngr('write',Sav_filename,MethodCOMP,...
            X,{level,wname,modeDWT},{threshold,nb_CLASSES},ColType);        
        X_decoded = wtcmngr('read',Sav_filename);        
    ...
    case {'lvl_mmc'}
        ...
        % Writing and Reading.
        %---------------------
        lvl_mmc_Cell = wtcmngr('write',Sav_filename,'lvl_mmc', ...
            X,{level,wname,modeDWT},bpp_Required,ColType);
        [X_decoded,CfsRec] = wtcmngr('read',Sav_filename);
        X_decoded = wd2uiorui2d('d2uint',X_decoded);
    ...
    case {'ezw','spiht','spiht_3d','stw','wdr','aswdr'}
        ...
        ezw_Encoded = ...
            wtcmngr('enc',MethodCOMP,X,wname,level,modeDWT,...
        ...
        % Writing and Reading.
        %---------------------
        wtcmngr('save',Sav_filename,MethodCOMP,ezw_Encoded);
end
