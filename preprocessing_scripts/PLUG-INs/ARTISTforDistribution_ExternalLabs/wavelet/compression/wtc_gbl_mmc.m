function varargout = wtc_gbl_mmc(option,varargin)
...
switch numOPT
    %----- 'encode' -----%
    case 1 , [varargout{1:nbout}] = gbl_mmc_enc(varargin{:});
    %----- 'decode' -----%
    case 2 , [varargout{1:nbout}] = gbl_mmc_dec(varargin{:});
    %------ 'save' ------%
    case 3 , [varargout{1:nbout}] = gbl_mmc_save(varargin{:});
    %------ 'load' ------%
    case 4 , [varargout{1:nbout}] = gbl_mmc_load(varargin{:});
    %---- 'quantize' ----%
...
%=======================================================================%
function gbl_mmc_Cell = gbl_mmc_enc(varargin)
...
switch wtcmngr('meth_ident',typeCODE)
    case 'h'    % Huffman
...
%=======================================================================%
function [Xrec,T] = gbl_mmc_dec(gbl_mmc_Cell,varargin)
...
[order , tn_of_TREE , type_of_DATA , size_of_DATA , WT_Settings] = ...
    deal(Dat_Par{:});
codeID = wtcmngr('meth_ident',typeCODE);
switch codeID
...
%=======================================================================%
function count = gbl_mmc_save(filename,gbl_mmc_Cell)
...
%=======================================================================%
function gbl_mmc_Cell = gbl_mmc_load(filename)
...
typeCODE = wtcmngr('meth_name',codeID);
%------------------------------------------    
