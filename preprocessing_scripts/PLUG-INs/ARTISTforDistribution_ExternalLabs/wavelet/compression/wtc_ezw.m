function varargout = wtc_ezw(option,varargin)
...
switch numOPT
    ...
    %--- 'save' ---%
    case 3 , [varargout{1:nbout}] = wtc_ezw_save(varargin{:});
    %--- 'load' ---%
    case 4 , [varargout{1:nbout}] = wtc_ezw_load(varargin{:});
end
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function fileSize = wtc_ezw_save(filename,WTC_Struct)
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function WTC_Struct = wtc_ezw_load(filename)
