function varargout = wtc_lvl_mmc(option,varargin)
...
switch numOPT
    ...
    case 2 , [varargout{1:nbout}] = lvl_mmc_dec(varargin{:});
        %------ 'save' ------%
    case 3 , [varargout{1:nbout}] = lvl_mmc_save(varargin{:});
        %------ 'load' ------%
    case 4 , [varargout{1:nbout}] = lvl_mmc_load(varargin{:});
        %---- 'quantize' ----%
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function count = lvl_mmc_save(filename,lvl_mmc_Cell)
        ...
        % Begin Saving.
        %--------------
        codeID = wtcmngr('meth_ident','lvl_mmc');
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
    function lvl_mmc_Cell = lvl_mmc_load(filename)
        ...
        typeCODE = wtcmngr('meth_name',codeID); %#ok<NASGU>  % Not used
