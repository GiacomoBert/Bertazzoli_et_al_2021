...
%% define stat dir
TEPs_stat_dir='Z:\Giacomo_20190828\Analysis\Post_processing\TEPs\NEW_postprocessing\Correlation_dot_product_NEW';
            ...
            while cond_count<=4
                ...
                for sub_count=1:16
                    ...
                    for time_count=1:600
                        selected_data1= struct2array(data_gavg_ind{pip_count,area_count,ses_count});
                        selected_data1= selected_data1.individual(sub_count,:,time_count);
                        selected_data2= struct2array(data_gavg_ind{cond_count,area_count,ses_count});
                ...
                %different RHO = 0
                [H_spear(comp_count,:),PvalSPEAR(comp_count,:)]= ...
                ...
                for sub_count=1:16
                    parfor inverse_count=1:length(z_RHO)
                ...
                % disp conditions
                data_gavg_ind{pip_count,area_count,ses_count}
                data_gavg_ind{cond_count,area_count,ses_count}
