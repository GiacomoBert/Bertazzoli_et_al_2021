% this scripts perfroms a post hoc t-test dep sampl for all the conditions
...
%% Create Layout
% load('D:\Giacomo_20190828\Analysis\Scripts\Vecchi script tesi Giacomo\elecLOCS_new.mat');
% cfg=[];
% cfg.elec = elec;
%
% layout = ft_prepare_layout(cfg, ARTIST_gr_avg_lP_T1);
...
%cfg.elec = elec;
cfg.feedback='yes';
neighbours = ft_prepare_neighbours(cfg, ARTIST_gr_avg_lP_T1); %rndm dataset
close

%%  POST HOC PAIRED dep sample TTEST
%parameters 

cfg=[];
cfg.channel     = 'all';
cfg.latency     = [0.006 0.350];
cfg.avgoverchan = 'no';
cfg.avgovertime = 'no';
cfg.parameter   = 'avg';
...
cfg.alpha=0.05/6; %six comparison 
cfg.tail=0;
cfg.correcttail = 'alpha'; %correct for the fact that the test is to sided
...
% in the clustering algorithm (default=0).cfg.tail  = 0;
cfg.clustertail = 0;
cfg.numrandomization = 1000; % number of draws from the permutation distribution

nsubj = 16;
design = zeros(2,2*nsubj); %construct design matrix
...
%lP T1
[stat_Post_hoc_TEPs_Ttest_lP_T1_AR_TM_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lP_T1{:}, TMSEEG_newICsel_all_avg_lP_T1{:});
[stat_Post_hoc_TEPs_Ttest_lP_T1_AR_TE_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lP_T1{:}, TESA_newICsel_all_avg_lP_T1{:});
[stat_Post_hoc_TEPs_Ttest_lP_T1_AR_SO_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lP_T1{:}, SOUND_normal_filt_check_all_avg_lP_T1{:});
[stat_Post_hoc_TEPs_Ttest_lP_T1_TM_TE_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lP_T1{:}, TESA_newICsel_all_avg_lP_T1{:});
[stat_Post_hoc_TEPs_Ttest_lP_T1_TM_SO_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lP_T1{:}, SOUND_normal_filt_check_all_avg_lP_T1{:});
[stat_Post_hoc_TEPs_Ttest_lP_T1_TE_SO_NEW] = ft_timelockstatistics(cfg,TESA_newICsel_all_avg_lP_T1{:}, SOUND_normal_filt_check_all_avg_lP_T1{:});

save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T1_AR_TM_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T1_AR_TM_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T1_AR_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T1_AR_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T1_AR_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T1_AR_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T1_TM_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T1_TM_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T1_TM_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T1_TM_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T1_TE_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T1_TE_SO_NEW');

%lP T2
[stat_Post_hoc_TEPs_Ttest_lP_T2_AR_TM_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lP_T2{:}, TMSEEG_newICsel_all_avg_lP_T2{:});
[stat_Post_hoc_TEPs_Ttest_lP_T2_AR_TE_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lP_T2{:}, TESA_newICsel_all_avg_lP_T2{:});
[stat_Post_hoc_TEPs_Ttest_lP_T2_AR_SO_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lP_T2{:}, SOUND_normal_filt_check_all_avg_lP_T2{:});
[stat_Post_hoc_TEPs_Ttest_lP_T2_TM_TE_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lP_T2{:}, TESA_newICsel_all_avg_lP_T2{:});
[stat_Post_hoc_TEPs_Ttest_lP_T2_TM_SO_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lP_T2{:}, SOUND_normal_filt_check_all_avg_lP_T2{:});
[stat_Post_hoc_TEPs_Ttest_lP_T2_TE_SO_NEW] = ft_timelockstatistics(cfg,TESA_newICsel_all_avg_lP_T2{:}, SOUND_normal_filt_check_all_avg_lP_T2{:});

save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T2_AR_TM_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T2_AR_TM_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T2_AR_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T2_AR_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T2_AR_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T2_AR_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T2_TM_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T2_TM_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T2_TM_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T2_TM_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lP_T2_TE_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lP_T2_TE_SO_NEW');

%lPF T1
[stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_TM_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lPF_T1{:}, TMSEEG_newICsel_all_avg_lPF_T1{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_TE_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lPF_T1{:}, TESA_newICsel_all_avg_lPF_T1{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_SO_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lPF_T1{:}, SOUND_normal_filt_check_all_avg_lPF_T1{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T1_TM_TE_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lPF_T1{:}, TESA_newICsel_all_avg_lPF_T1{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T1_TM_SO_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lPF_T1{:}, SOUND_normal_filt_check_all_avg_lPF_T1{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T1_TE_SO_NEW] = ft_timelockstatistics(cfg,TESA_newICsel_all_avg_lPF_T1{:}, SOUND_normal_filt_check_all_avg_lPF_T1{:});

save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_TM_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_TM_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T1_AR_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T1_TM_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T1_TM_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T1_TM_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T1_TM_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T1_TE_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T1_TE_SO_NEW');

%lPF T2
[stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_TM_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lPF_T2{:}, TMSEEG_newICsel_all_avg_lPF_T2{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_TE_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lPF_T2{:}, TESA_newICsel_all_avg_lPF_T2{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_SO_NEW] = ft_timelockstatistics(cfg,ARTIST_all_avg_lPF_T2{:}, SOUND_normal_filt_check_all_avg_lPF_T2{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T2_TM_TE_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lPF_T2{:}, TESA_newICsel_all_avg_lPF_T2{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T2_TM_SO_NEW] = ft_timelockstatistics(cfg,TMSEEG_newICsel_all_avg_lPF_T2{:}, SOUND_normal_filt_check_all_avg_lPF_T2{:});
[stat_Post_hoc_TEPs_Ttest_lPF_T2_TE_SO_NEW] = ft_timelockstatistics(cfg,TESA_newICsel_all_avg_lPF_T2{:}, SOUND_normal_filt_check_all_avg_lPF_T2{:});

save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_TM_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_TM_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T2_AR_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T2_TM_TE_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T2_TM_TE_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T2_TM_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T2_TM_SO_NEW');
save([TEPs_stat_dir '\stat_Post_hoc_TEPs_Ttest_lPF_T2_TE_SO_NEW'], 'stat_Post_hoc_TEPs_Ttest_lPF_T2_TE_SO_NEW');
